...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just sauntered into a scullery. The room is well lit.

 You can see a bowl. The bowl is typical.[if there is something on the s_0] On the bowl you see [a list of things on the s_0].[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if there is nothing on the s_0] The bowl appears to be empty.[end if]".
The scullery part 2 is some text that varies. The scullery part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is " gate leading west. You need an unblocked exit? You should try going south.".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You're now in a cellar. You can barely contain your excitement.
...
The cellar part 2 is some text that varies. The cellar part 2 is " gateway leading south.".
...
The studio part 0 is some text that varies. The studio part 0 is "You've just shown up in a studio.
 ...
 You make out a shelf. The shelf is ordinary.[if there is something on the s_1] On the shelf you make out [a list of things on the s_1]. Huh, weird.[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_1] But the thing is empty, unfortunately. What, you think everything in TextWorld should have stuff on it?[end if]".
The studio part 2 is some text that varies. The studio part 2 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The studio part 3 is some text that varies. The studio part 3 is " gateway leading north. There is an exit to the south. Don't worry, it is unblocked.".
...
The o_0 and the o_2 and the o_3 and the o_5 and the o_4 and the o_1 are object-likes.
The o_0 and the o_2 and the o_3 and the o_5 and the o_4 and the o_1 are privately-named.
The r_3 and the r_2 and the r_0 and the r_1 and the r_4 are rooms.
...
The o_0 is in r_3.
The description of o_2 is "The cane is brand new.".
The printed name of o_2 is "cane".
Understand "cane" as o_2.
The o_2 is in r_2.
The description of o_3 is "The insect seems well matched to everything else here".
The printed name of o_3 is "insect".
Understand "insect" as o_3.
The o_3 is in r_0.
The description of o_5 is "The fly larva is brand new.".
...
The description of o_4 is "The nest of beetles is unremarkable.".
...
The description of o_1 is "The teacup appears out of place here".
...
Test quest0_0 with "unlock gate with keycard / open gate / go east / take butterfly / put butterfly on bowl"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First step, unlock the gate. And then, doublecheck that the gate is wide o".
The objective part 1 is some text that varies. The objective part 1 is "pen. And then, head east. Then, retrieve the butterfly from the floor of the scullery. And then, rest the butterfly on the bowl. Once that's all handled, you can stop!".
