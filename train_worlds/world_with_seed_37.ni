...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in a canteen. An ordinary kind of place.
 ...
 You smell an intriguing smell, and follow it to a non-euclidean chest. Now why would someone leave that there?[if c_0 is open and there is something in the c_0] The non-euclidean chest contains [a list of things in the c_0].[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is "[if c_0 is open and the c_0 contains nothing] The non-euclidean chest is empty, what a horrible day![end if]".
The canteen part 2 is some text that varies. The canteen part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a pan. [if there is something on the s_1]On the pan you can make out [a list of things on the s_1].[end if]".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is "[if there is nothing on the s_2]However, the table, like an empty table, has nothing on it.[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You make a grand eccentric entrance into a workshop.
 ...
 You can make out a mantelpiece. The mantelpiece is standard.[if there is something on the s_0] On the mantelpiece you can make out [a list of things on the s_0]. Classic TextWorld.[end if]".
...
The description of c_0 is "The non-euclidean chest looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_0 is in r_3.
The f_0 is edible.
The description of f_1 is "The banana looks tantalizing.".
...
The s_2 is in r_3.
The description of f_2 is "The berry looks savory.".
...
Test quest0_0 with "go north / take non-euclidean key from mantelpiece / go east / go south / lock non-euclidean chest with non-euclidean key"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could travel north. With that accomplished, pick up the non-eucli".
The objective part 1 is some text that varies. The objective part 1 is "dean key from the mantelpiece within the workshop. Then, go east. And then, go south. With that done, lock the non-euclidean chest in the canteen. Once that's all handled, you can stop!".
