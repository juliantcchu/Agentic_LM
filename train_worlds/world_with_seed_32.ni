...
The workshop part 4 is some text that varies. The workshop part 4 is "[if c_1 is open and the c_1 contains nothing] The locker is empty, what a horrible day![end if]".
The workshop part 5 is some text that varies. The workshop part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The workshop part 6 is some text that varies. The workshop part 6 is " passageway leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The workshop part 7 is some text that varies. The workshop part 7 is " door leading west.".
...
The chamber part 3 is some text that varies. The chamber part 3 is " door leading east. There is an unblocked exit to the south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 Were you looking for a mantelpiece? Because look over there, it's a mantelpiece. The mantelpiece is usual.[if there is something on the s_0] On the mantelpiece you can make out [a list of things on the s_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is " passageway leading south. There is an exit to the west. Don't worry, it is unblocked.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. A normal kind of place. You start to take note of what's in the room.

 You see a board. You wonder idly who left that here. [if there is something on the s_1]On the board you see [a list of things on the s_1].[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it.[end if]".
...
The description of o_1 is "The pillow looks out of place here".
...
Test quest0_0 with "open locker / take latchkey from locker / unlock box with latchkey / open box / take folder from box"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, open the locker inside the workshop. After that, take the latchkey from the locker. And then,".
The objective part 1 is some text that varies. The objective part 1 is " unlock the box with the latchkey. After that, ensure that the box in the workshop is open. Then, pick up the folder from the box in the workshop. Alright, thanks!".
