...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. A typical kind of place.
 ...
 You make out a locker. I mean, just wow! Isn't TextWorld just the best?[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
...
The chamber part 2 is some text that varies. The chamber part 2 is " You see [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The chamber part 3 is some text that varies. The chamber part 3 is " portmanteau.[if c_1 is open and there is something in the c_1] The portmanteau contains [a list of things in the c_1].[end if]".
...
The salon part 0 is some text that varies. The salon part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just shown up in the salon. You try to gain information on your surroundings by using a technique you call 'looking.'

 You can make out a shelf. The shelf is typical.[if there is something on the s_0] On the shelf you make out [a list of things on the s_0].[end if]".
The salon part 1 is some text that varies. The salon part 1 is "[if there is nothing on the s_0] However, the shelf, like an empty shelf, has nothing on it.[end if]".
The salon part 2 is some text that varies. The salon part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The salon part 3 is some text that varies. The salon part 3 is " gateway leading south. There is an exit to the east. Don't worry, it is unguarded. You don't like doors? Why not try going north, that entranceway is unguarded.".
...
The washroom part 1 is some text that varies. The washroom part 1 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The drawer is empty![end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. An ordinary one.
 ...
 You can see a safe. Huh, weird.[if c_3 is open and there is something in the c_3] The safe contains [a list of things in the c_3].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if c_3 is open and the c_3 contains nothing] The safe is empty! What a waste of a day![end if]".
The studio part 2 is some text that varies. The studio part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The studio part 3 is some text that varies. The studio part 3 is " gateway leading north. You don't like doors? Why not try going east, that entranceway is unguarded.".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well, here we are in a cookhouse.
 ...
 You can see a board. The board is usual.[if there is something on the s_1] On the board you can make out [a list of things on the s_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
Test quest0_0 with "go east / take key / unlock locker with key / open locker / insert Comic Strip Calendar into locker"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First of all, you could, like, make an effort to take a trip east. If you can succ".
The objective part 1 is some text that varies. The objective part 1 is "eed at that, retrieve the key from the floor of the chamber. After you have taken the key, check that the locker is unlocked with the key. After that, ensure that the locker in the chamber is open. An".
The objective part 2 is some text that varies. The objective part 2 is "d then, put the Comic Strip Calendar into the locker. And if you do that, you're the winner!".
