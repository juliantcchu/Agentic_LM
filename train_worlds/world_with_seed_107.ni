...
The studio part 1 is some text that varies. The studio part 1 is " locker.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_0 is open and the c_0 contains nothing] The locker is empty! This is the worst thing that could possibly happen, ever![end if]".
The studio part 3 is some text that varies. The studio part 3 is " You make out a display.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The studio part 4 is some text that varies. The studio part 4 is "[if c_1 is open and the c_1 contains nothing] The display is empty! What a waste of a day![end if]".
The studio part 5 is some text that varies. The studio part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The studio part 6 is some text that varies. The studio part 6 is " passageway leading west. You need an unguarded exit? You should try going east. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The study part 0 is some text that varies. The study part 0 is "You've just sauntered into a study. Let's see what's in here.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 1 is some text that varies. The study part 1 is " passageway leading east. You need an unguarded exit? You should try going south.".
...
The shower part 1 is some text that varies. The shower part 1 is " drawer, which looks typical, right there by you.[if c_2 is open and there is something in the c_2] The drawer contains [a list of things in the c_2].[end if]".
The shower part 2 is some text that varies. The shower part 2 is "[if c_2 is open and the c_2 contains nothing] The drawer is empty! What a waste of a day![end if]".
...
The garage part 0 is some text that varies. The garage part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a garage. Let's see what's in here.

 You smell an interesting smell, and follow it to a chest.[if c_3 is open and there is something in the c_3] The chest contains [a list of things in the c_3].[end if]".
...
The garage part 2 is some text that varies. The garage part 2 is " You see a stand. The stand is typical.[if there is something on the s_0] On the stand you see [a list of things on the s_0].[end if]".
The garage part 3 is some text that varies. The garage part 3 is "[if there is nothing on the s_0] But the thing is empty. It would have been so cool if there was stuff on the stand! oh well.[end if]".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. A typical kind of place. The room is well lit.
...
Test quest0_0 with "go north / go east / take keycard / go west / lock locker with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First off, attempt to go to the north. That done, venture east. Next, pi".
The objective part 1 is some text that varies. The objective part 1 is "ck up the keycard from the floor of the shower. After that, make an attempt to head west. Following that, lock the locker with the keycard. Got that? Good!".
