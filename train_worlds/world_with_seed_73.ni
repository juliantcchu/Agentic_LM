...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A normal one. You begin to take stock of what's in the room.

 [if c_0 is locked]A locked[else if c_0 is open]An open[otherwise]A closed[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is " locker is in the corner.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
...
The cubicle part 4 is some text that varies. The cubicle part 4 is " passageway leading east. You don't like doors? Why not try going north, that entranceway is unblocked. There is an unblocked exit to the west.".
...
The steam room part 1 is some text that varies. The steam room part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk.[end if]".
The steam room part 2 is some text that varies. The steam room part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The steam room part 3 is some text that varies. The steam room part 3 is " passageway leading west. You don't like doors? Why not try going north, that entranceway is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. You begin to take stock of what's in the room.
...
The parlor part 0 is some text that varies. The parlor part 0 is "Look at you, bigshot, walking into a parlor like it isn't some huge deal.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a Canadian style locker.[if c_1 is open and there is something in the c_1] The Canadian style locker contains [a list of things in the c_1].[end if]".
The parlor part 1 is some text that varies. The parlor part 1 is "[if c_1 is open and the c_1 contains nothing] The Canadian style locker is empty, what a horrible day![end if]".
...
The c_0 is in r_0.
The c_0 is open.
The description of c_1 is "The Canadian style locker looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_1 is "Canadian style locker".
Understand "Canadian style locker" as c_1.
...
The f_1 is in r_2.
The f_1 is edible.
The description of o_0 is "The napkin would seem to be out of place here".
The printed name of o_0 is "napkin".
Understand "napkin" as o_0.
The o_0 is in r_1.
The description of o_1 is "The cd seems well matched to everything else here".
...
The description of k_1 is "The Canadian style passkey looks useful".
The printed name of k_1 is "Canadian style passkey".
Understand "Canadian style passkey" as k_1.
...
Test quest0_0 with "open Canadian style locker / take passkey from Canadian style locker"
...
Test quest1_0 with "open Canadian style locker / take passkey from Canadian style locker / go south / close locker / lock locker with passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound game of TextWorld! Here is your task for today. Your first objective is to assure that the Canadian style locker is opened. Once you have pulled open the Canadian style ".
The objective part 1 is some text that varies. The objective part 1 is "locker, recover the passkey from the Canadian style locker. And then, take a trip south. And then, close the locker. Then, make it so that the locker is locked. That's it!".
