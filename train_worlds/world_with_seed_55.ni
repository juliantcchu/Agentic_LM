...
The laundromat part 1 is some text that varies. The laundromat part 1 is " trunk.[if c_0 is open and there is something in the c_0] The trunk contains [a list of things in the c_0].[end if]".
...
The laundromat part 3 is some text that varies. The laundromat part 3 is " You scan the room, seeing a board. [if there is something on the s_0]On the board you make out [a list of things on the s_0].[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " door leading south. There is an exit to the east. Don't worry, it is unguarded.".
...
The launderette part 1 is some text that varies. The launderette part 1 is " passageway leading north. You need an unblocked exit? You should try going east.".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cookhouse.
 ...
 You can see a refrigerator. Now that's what I call TextWorld![if c_1 is open and there is something in the c_1] The refrigerator contains [a list of things in the c_1]. You wonder idly who left that here.[end if]".
...
The cookhouse part 2 is some text that varies. The cookhouse part 2 is "
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is " door leading north. There is [if d_0 is open]an open[otherwise]a closed[end if]".
...
The d_0 is closed.
The description of d_1 is "The door looks rugged. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The o_1 is in r_3.
The description of o_2 is "The disk appears to fit in here".
...
Test quest0_0 with "unlock door with key / open door / go north / go east / take sponge from board"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First thing I need you to do is to insert the key into the door in the cookhouse's lock to ".
The objective part 1 is some text that varies. The objective part 1 is "unlock it. Then, open the door in the cookhouse. And then, head north. With that accomplished, travel east. And then, take the sponge from the board in the laundromat. Alright, thanks!".
