...
The cookery part 1 is some text that varies. The cookery part 1 is " type J passageway leading west. You need an unblocked exit? You should try going east.".
...
The shower part 0 is some text that varies. The shower part 0 is "You find yourself in a shower. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The shower part 1 is some text that varies. The shower part 1 is " type J passageway leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 Look over there! a shelf. [if there is something on the s_0]On the shelf you make out [a list of things on the s_0]. Huh, weird.[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is "[if there is nothing on the s_0]But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The garage part 0 is some text that varies. The garage part 0 is "You've entered a garage. Okay, just remember what you're here to do, and everything will go great.
 ...
 You make out a box. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0].[end if]".
...
The studio part 1 is some text that varies. The studio part 1 is " gate leading south. There is an unguarded exit to the east.".
...
The d_1 is open.
The description of d_0 is "it is what it is, a type J passageway [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "type J passageway".
Understand "type J passageway" as d_0.
...
The f_1 is in r_2.
The f_1 is edible.
The description of f_3 is "The cookie looks appealing.".
The printed name of f_3 is "cookie".
Understand "cookie" as f_3.
The f_3 is in r_3.
The f_3 is edible.
The description of o_0 is "The knife appears well matched to everything else here".
...
The description of f_2 is "that's a normal cauliflower!".
The printed name of f_2 is "cauliflower".
Understand "cauliflower" as f_2.
The f_2 is edible.
The player carries the f_2.
The description of k_0 is "The type J passkey looks useful".
The printed name of k_0 is "type J passkey".
Understand "type J passkey" as k_0.
...
The description of o_1 is "The Quote of the Day Calendar seems to fit in here".
...
Test quest0_0 with "go south / unlock type J passageway with type J passkey / open type J passageway / go east / take knife"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First step, make an effort to travel south. After that, doublecheck that the type J".
The objective part 1 is some text that varies. The objective part 1 is " passageway inside the shower is unlocked. Then, ensure that the type J passageway is open. Then, make an effort to head east. And then, pick-up the knife from the floor of the cookery. Alright, thank".
