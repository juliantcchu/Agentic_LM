...
The bedchamber part 2 is some text that varies. The bedchamber part 2 is " You see a recliner. The recliner is standard.[if there is something on the s_1] On the recliner you see [a list of things on the s_1].[end if]".
...
The bedchamber part 5 is some text that varies. The bedchamber part 5 is " gate leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The laundromat part 1 is some text that varies. The laundromat part 1 is " box is in the corner.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0].[end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is "[if c_0 is open and the c_0 contains nothing] The box is empty! This is the worst thing that could possibly happen, ever![end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is " door leading east. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You're now in the workshop.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is " gate leading west. You need an unblocked exit? You should try going north.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " Henderson's chest.[if c_1 is open and there is something in the c_1] The Henderson's chest contains [a list of things in the c_1]. Wow, isn't TextWorld just the best?[end if]".
...
The description of d_1 is "The door looks manageable. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_0 is in r_1.
The c_0 is locked.
The description of c_1 is "The Henderson's chest looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_0 is in r_1.
The f_0 is edible.
The description of k_2 is "The Henderson's passkey is weighty.".
...
The description of o_1 is "The fork is antiquated.".
...
Test quest0_0 with "go north / open door / go east / take monitor from recliner / put monitor on couch"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, make an attempt to take a trip north. If you can do that, ensure that the door is open. And ".
The objective part 1 is some text that varies. The objective part 1 is "then, travel east. And then, pick up the monitor from the recliner in the bedchamber. After taking the monitor, rest the monitor on the couch inside the bedchamber. That's it!".
