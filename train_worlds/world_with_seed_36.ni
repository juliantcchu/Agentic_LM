...
The kitchen part 1 is some text that varies. The kitchen part 1 is " non-euclidean door leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've entered a sauna.
 ...
 You can see a board. [if there is something on the s_0]On the board you can make out [a list of things on the s_0].[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is "[if there is nothing on the s_0]But the thing is empty. Hm. Oh well[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. A standard one. You begin looking for stuff.

 You see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is " trunk nearby.[if c_0 is open and there is something in the c_0] The trunk contains [a list of things in the c_0].[end if]".
The workshop part 2 is some text that varies. The workshop part 2 is "[if c_0 is open and the c_0 contains nothing] The trunk is empty! What a waste of a day![end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "Welcome to the spare room.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is " non-euclidean door leading south. You need an unblocked exit? You should try going east.".
...
The d_1 is closed.
The description of d_0 is "The non-euclidean door looks solid. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_0 is "non-euclidean door".
Understand "non-euclidean door" as d_0.
...
The description of o_0 is "The coffee cup appears to be out of place here".
...
The s_0 is in r_1.
The description of f_0 is "The coconut looks savory.".
...
The description of f_2 is "that's a typical chocolate bar!".
...
The description of o_2 is "The bug is cheap looking.".
...
Test quest0_0 with "take non-euclidean passkey / unlock non-euclidean door with non-euclidean passkey / open non-euclidean door / go south / take coffee cup"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! First stop, pick-up the non-euclidean passkey from the floor of the spare room. And then, make absolutely sure that the non-euclidean door is unl".
The objective part 1 is some text that varies. The objective part 1 is "ocked. And then, ensure that the non-euclidean door is open. And then, go to the south. That done, pick-up the coffee cup from the floor of the kitchen. And if you do that, you're the winner!".
