...
The bar part 0 is some text that varies. The bar part 0 is "You find yourself in a bar. An usual one.
 ...
 Hey, want to see a chest? Look over there, a chest. Wow, isn't TextWorld just the best?[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
...
The bar part 2 is some text that varies. The bar part 2 is " You make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The bar part 3 is some text that varies. The bar part 3 is " coffer, which looks ordinary, close by.[if c_1 is open and there is something in the c_1] The coffer contains [a list of things in the c_1].[end if]".
The bar part 4 is some text that varies. The bar part 4 is "[if c_1 is open and the c_1 contains nothing] The coffer is empty! What a waste of a day![end if]".
The bar part 5 is some text that varies. The bar part 5 is " You hear a noise behind you and spin around, but you can't see anything other than a bench. The bench is normal.[if there is something on the s_0] On the bench you can see [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The bar part 6 is some text that varies. The bar part 6 is "[if there is nothing on the s_0] But the thing hasn't got anything on it.[end if]".
The bar part 7 is some text that varies. The bar part 7 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bar part 8 is some text that varies. The bar part 8 is " formless portal leading west. There is an unguarded exit to the east.".
The description of r_1 is "[bar part 0][bar part 1][bar part 2][bar part 3][bar part 4][bar part 5][bar part 6][bar part 7][bar part 8]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've entered a pantry.
 ...
 What's that over there? It looks like it's a stand. [if there is something on the s_1]On the stand you can make out [a list of things on the s_1].[end if]".
...
The pantry part 2 is some text that varies. The pantry part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is " formless portal leading east. You need an unguarded exit? You should try going north. There is an exit to the south. Don't worry, it is unguarded.".
...
The salon part 0 is some text that varies. The salon part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just walked into the salon. I guess you better just go and list everything you see here.
 ...
 You see a mantelpiece. The mantelpiece is normal.[if there is something on the s_2] On the mantelpiece you make out [a list of things on the s_2].[end if]".
...
The description of d_0 is "The formless portal looks commanding. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of k_0 is "The formless keycard looks useful".
...
Test quest0_0 with "go west / unlock chest with latchkey / open chest / take formless keycard from chest / lock formless portal with formless keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could head west. Then, assure that the chest is unlocked with the latchk".
The objective part 1 is some text that varies. The objective part 1 is "ey. And then, assure that the chest is opened. If you have opened the chest, take the formless keycard from the chest inside the bar. And then, look and see that the formless portal is locked. Got tha".
The objective part 2 is some text that varies. The objective part 2 is "t? Good!".
