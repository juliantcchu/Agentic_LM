...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cookhouse.
 ...
 You can make out a rack. The rack is normal.[if there is something on the s_0] On the rack you make out [a list of things on the s_0].[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. What's the point of an empty rack?[end if]".
...
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_1]The table appears to be empty.[end if]".
...
The spare room part 1 is some text that varies. The spare room part 1 is " safe right there by you.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0].[end if]".
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A standard kind of place. You begin to take stock of what's in the room.

 You scan the room, seeing a coffer.[if c_1 is open and there is something in the c_1] The coffer contains [a list of things in the c_1].[end if]".
The office part 1 is some text that varies. The office part 1 is "[if c_1 is open and the c_1 contains nothing] The coffer is empty! What a waste of a day![end if]".
...
The f_2 is in r_2.
The f_2 is edible.
The description of o_2 is "The fly larva is unremarkable.".
...
The description of o_1 is "The backup calendar is brand new.".
...
Test quest0_0 with "go east / go north / go west / take insect from rack / drop insect"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to make an effort to go to the east. After that, ma".
The objective part 1 is some text that varies. The objective part 1 is "ke an attempt to take a trip north. Then, move west. After that, retrieve the insect from the rack in the cookhouse. Having picked up the insect, place the insect on the floor of the cookhouse. And if".
The objective part 2 is some text that varies. The objective part 2 is " you do that, you're the winner!".
