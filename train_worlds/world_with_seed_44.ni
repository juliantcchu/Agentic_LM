...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in an usual kind of place. That is to say, you're in a cubicle.
 ...
 You see a stand. [if there is something on the s_1]On the stand you can see [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
...
The cubicle part 3 is some text that varies. The cubicle part 3 is " gate leading north. There is an unblocked exit to the east. You need an unguarded exit? You should try going west.".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. An ordinary kind of place. You begin to take stock of what's here.
 ...
 You make out a bench. [if there is something on the s_0]You see [a list of things on the s_0] on the bench. Huh, weird.[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_0]The bench appears to be empty. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The canteen part 0 is some text that varies. The canteen part 0 is "I just think it's awesome that you're in a canteen now.

 You scan the room for a Canadian style safe, and you find a Canadian style safe. Wow, check out the price tag on the Canadian style safe! Forty big ones![if c_0 is open and there is something in the c_0] The Canadian style safe contains [a list of things in the c_0]. Hmmm... what else, what else?[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is "[if c_0 is open and the c_0 contains nothing] The Canadian style safe is empty, what a horrible day![end if]".
The canteen part 2 is some text that varies. The canteen part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The canteen part 3 is some text that varies. The canteen part 3 is " gate leading south. You don't like doors? Why not try going north, that entranceway is unguarded.".
...
The f_1 is in r_2.
The f_1 is edible.
The description of f_2 is "that's a standard salad!".
...
Test quest0_0 with "go west / go west / take mat from bench / go east / drop mat"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Here is your task for today. Your first objective is to move west. Then, move west. Following that, take the mat from the bench. And then, make an effo".
The objective part 1 is some text that varies. The objective part 1 is "rt to move east. And then, drop the mat on the floor of the cubicle. And if you do that, you're the winner!".
