...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A normal kind of place. I guess you better just go and list everything you see here.

 You see a type S box.[if c_0 is open and there is something in the c_0] The type S box contains [a list of things in the c_0].[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The type S box is empty![end if]".
The sauna part 2 is some text that varies. The sauna part 2 is " You can make out a cabinet.[if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1].[end if]".
...
The vault part 0 is some text that varies. The vault part 0 is "You are in a vault. An usual kind of place.
 ...
 You smell a wretched smell, and follow it to a toolbox. You look at the price tag on the toolbox. Forty dollars?! Where'd they buy this toolbox, some kind of expensive place?[if c_2 is open and there is something in the c_2] The toolbox contains [a list of things in the c_2].[end if]".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You arrive in a cookhouse. I guess you better just go and list everything you see here.
 ...
 Oh wow! Is that what I think it is? It is! It's a bowl. The bowl is usual.[if there is something on the s_0] On the bowl you make out [a list of things on the s_0].[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if there is nothing on the s_0] But the thing is empty.[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is " Oh wow! Is that what I think it is? It is! It's a board. The board is usual.[if there is something on the s_1] On the board you see [a list of things on the s_1].[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of junk.[end if]".
The cookhouse part 4 is some text that varies. The cookhouse part 4 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The cookhouse part 5 is some text that varies. The cookhouse part 5 is " passageway leading south. There is [if d_0 is open]an open[otherwise]a closed[end if]".
The cookhouse part 6 is some text that varies. The cookhouse part 6 is " hatch leading west.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just walked into a pantry. The room is well lit.
 ...
 You make out a trunk. There's something strange about this being here, but you can't put your finger on it.[if c_3 is open and there is something in the c_3] The trunk contains [a list of things in the c_3].[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if c_3 is open and the c_3 contains nothing] The trunk is empty, what a horrible day![end if]".
The pantry part 2 is some text that varies. The pantry part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The pantry part 3 is some text that varies. The pantry part 3 is " hatch leading east. There is an unguarded exit to the north.".
...
The description of k_0 is "The metal of the type S passkey is polished.".
...
Test quest0_0 with "open passageway / go north / take type S passkey from bowl / go south / lock type S box with type S passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound episode of TextWorld! Here is your task for today. First thing I need you to do is to open the passageway. After you have pulled open the passageway, take a trip north. ".
The objective part 1 is some text that varies. The objective part 1 is "Then, take the type S passkey from the bowl. After that, try to go to the south. If you can accomplish that, lock the type S box. And once you've done that, you win!".
