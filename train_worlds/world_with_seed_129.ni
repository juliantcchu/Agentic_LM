...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You are in a laundromat. A typical one.
 ...
 You can see a chest.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is "[if c_0 is open and the c_0 contains nothing] The chest is empty! What a waste of a day![end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is " You see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is " basket.[if c_2 is open and there is something in the c_2] The basket contains [a list of things in the c_2].[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The basket is empty![end if]".
The laundromat part 5 is some text that varies. The laundromat part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundromat part 6 is some text that varies. The laundromat part 6 is " gate leading south. There is an exit to the east. Don't worry, it is unblocked. There is an unguarded exit to the west.".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just sauntered into a scullery.
 ...
 You can make out a table. The table is ordinary.[if there is something on the s_0] On the table you can make out [a list of things on the s_0].[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. Oh! Why couldn't there just be stuff on it?[end if]".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is " cabinet close by.[if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The cabinet is empty![end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is " You can make out a portmanteau.[if c_3 is open and there is something in the c_3] The portmanteau contains [a list of things in the c_3].[end if]".
The cubicle part 4 is some text that varies. The cubicle part 4 is "[if c_3 is open and the c_3 contains nothing] The portmanteau is empty, what a horrible day![end if]".
...
The basement part 0 is some text that varies. The basement part 0 is "You've just sauntered into a basement.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 1 is some text that varies. The basement part 1 is " gate leading north. There is an exit to the east. Don't worry, it is unblocked.".
...
The o_1 is in r_1.
The description of o_2 is "The spork seems to fit in here".
...
Test quest0_0 with "go east / take keycard from cabinet"
...
Test quest1_0 with "go east / take keycard from cabinet / go west / close chest / lock chest with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, go east. After that, retrieve the keycard from the cabinet. ".
The objective part 1 is some text that varies. The objective part 1 is "With the keycard, attempt to travel west. And then, close the chest. After that, lock the chest inside the laundromat. And if you do that, you're the winner!".
