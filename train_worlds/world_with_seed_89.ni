...
The study part 2 is some text that varies. The study part 2 is " You can see a trunk.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
The study part 3 is some text that varies. The study part 3 is "[if c_1 is open and the c_1 contains nothing] The trunk is empty! What a waste of a day![end if]".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just shown up in the cubicle. You can barely contain your excitement.

 You see a toolbox. Huh, weird.[if c_2 is open and there is something in the c_2] The toolbox contains [a list of things in the c_2]. Hmmm... what else, what else?[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. A normal kind of place.
 ...
 You can see a bookshelf. [if there is something on the s_0]On the bookshelf you can see [a list of things on the s_0].[end if]".
...
The description of o_2 is "The ladle is brand new.".
...
Test quest0_0 with "go east / take latchkey / unlock chest with latchkey / open chest / take printer from chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, head east. Then, pick up the latchkey from the floor of the study. And th".
The objective part 1 is some text that varies. The objective part 1 is "en, unlock the chest in the study with the latchkey. After that, make sure that the chest is opened. Then, retrieve the printer from the chest inside the study. Alright, thanks!".
