...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You're now in the cubicle. You can barely contain your excitement.
 ...
 You see a chest. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The cubicle part 2 is some text that varies. The cubicle part 2 is " Oh wow! Is that what I think it is? It is! It's a table. The table is normal.[if there is something on the s_0] On the table you see [a list of things on the s_0].[end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. Hm. Oh well[end if]".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. An usual kind of place.
 ...
 Oh, great. Here's a locker.[if c_1 is open and there is something in the c_1] The locker contains [a list of things in the c_1].[end if]".
...
The washroom part 3 is some text that varies. The washroom part 3 is " door leading north. There is an exit to the east. Don't worry, it is unguarded.".
...
The cookhouse part 1 is some text that varies. The cookhouse part 1 is " portal leading west. You don't like doors? Why not try going east, that entranceway is unguarded.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "This might come as a shock to you, but you've just moved into a sauna. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The sauna part 2 is some text that varies. The sauna part 2 is " door leading south.".
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You've entered a recreation zone. You begin to take stock of what's here.
...
The f_0 is in r_1.
The f_0 is edible.
The description of o_2 is "The bug appears out of place here".
The printed name of o_2 is "bug".
Understand "bug" as o_2.
The o_2 is in r_2.
The description of o_3 is "The blanket is unremarkable.".
...
The description of o_0 is "The backup calendar looks out of place here".
...
The description of o_1 is "The golf tee is dirty.".
...
Test quest0_0 with "go east / take key from table / unlock chest with key / open chest / take backup calendar from chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First thing I need you to do is to try to venture east. And then, pick up the key from the table within".
The objective part 1 is some text that varies. The objective part 1 is " the cubicle. If you have got the key, unlock the chest within the cubicle. After that, open the chest within the cubicle. After that, recover the backup calendar from the chest. And if you do that, y".
The objective part 2 is some text that varies. The objective part 2 is "ou're the winner!".
