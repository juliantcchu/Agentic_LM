...
The study part 1 is some text that varies. The study part 1 is " box.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0].[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_0 is open and the c_0 contains nothing] The box is empty, what a horrible day![end if]".
The study part 3 is some text that varies. The study part 3 is " You can see a bookshelf. The bookshelf is standard.[if there is something on the s_0] On the bookshelf you make out [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
The study part 4 is some text that varies. The study part 4 is "[if there is nothing on the s_0] The bookshelf appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The study part 5 is some text that varies. The study part 5 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The study part 6 is some text that varies. The study part 6 is " door leading north. There is an exit to the west. Don't worry, it is unguarded.".
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. An usual kind of place.
 ...
 You make out a shelf. [if there is something on the s_1]On the shelf you can make out [a list of things on the s_1], so there's that.[end if]".
...
The bar part 3 is some text that varies. The bar part 3 is " hatch leading west. You don't like doors? Why not try going north, that entranceway is unblocked.".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A typical one. You can barely contain your excitement.

 You can see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is " trunk.[if c_2 is open and there is something in the c_2] The trunk contains [a list of things in the c_2]. Now that's what I call TextWorld![end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The trunk is empty![end if]".
...
The cubicle part 5 is some text that varies. The cubicle part 5 is " door leading south.".
...
The f_0 is in r_2.
The f_0 is edible.
The description of o_1 is "The desktop computer is cheap looking.".
...
The description of o_0 is "The Comic Strip Calendar is modern.".
...
Test quest0_0 with "take passkey from bookshelf / unlock box with passkey / open box / take Comic Strip Calendar from box / put Comic Strip Calendar on bookshelf"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, retrieve the passkey from the bookshelf. And then, unlock the box within the study with the passkey. Then, ensure ".
The objective part 1 is some text that varies. The objective part 1 is "that the box is open. After that, retrieve the Comic Strip Calendar from the box within the study. After getting the Comic Strip Calendar, sit the Comic Strip Calendar on the bookshelf. Got that? Good".
