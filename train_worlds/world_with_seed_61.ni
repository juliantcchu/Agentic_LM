...
The garage part 1 is some text that varies. The garage part 1 is " crate.[if c_0 is open and there is something in the c_0] The crate contains [a list of things in the c_0].[end if]".
The garage part 2 is some text that varies. The garage part 2 is "[if c_0 is open and the c_0 contains nothing] The crate is empty! What a waste of a day![end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "Look at you, bigshot, walking into a shower like it isn't some huge deal.
 ...
 You can see a drawer.[if c_1 is open and there is something in the c_1] The drawer contains [a list of things in the c_1]. Now why would someone leave that there?[end if]".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well how about that, you are in a place we're calling a kitchen.
 ...
 You can see a chair. The chair is usual.[if there is something on the s_0] On the chair you can make out [a list of things on the s_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You find yourself in a restroom. A standard one.
 ...
 You can make out a bench. The bench is usual.[if there is something on the s_1] On the bench you can make out [a list of things on the s_1].[end if]".
The restroom part 1 is some text that varies. The restroom part 1 is "[if there is nothing on the s_1] However, the bench, like an empty bench, has nothing on it.[end if]".
...
The f_0 is in r_1.
The f_0 is edible.
The description of o_2 is "The controller would seem to be to fit in here".
...
The description of o_0 is "The nest of kittens is antiquated.".
...
The description of o_1 is "The lamp is modern.".
...
Test quest0_0 with "go east / go south / go east / take nest of kittens from crate / drop nest of kittens"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to head east. Okay, and then, make an attempt to venture south. Then, head east. With that over with, take the nest of kittens from t".
The objective part 1 is some text that varies. The objective part 1 is "he crate. After you have taken the nest of kittens, throw the nest of kittens on the floor of the garage. And once you've done that, you win!".
