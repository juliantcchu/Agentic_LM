...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A typical kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 You scan the room, seeing a box. Hmm. You always thought you'd be more excited to see a box in a room.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0]. The light flickers for a second, but nothing else happens.[end if]".
The closet part 1 is some text that varies. The closet part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The box is empty![end if]".
The closet part 2 is some text that varies. The closet part 2 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The closet part 3 is some text that varies. The closet part 3 is " hatch leading north. There is an exit to the west. Don't worry, it is unblocked.".
...
The spare room part 1 is some text that varies. The spare room part 1 is " rectangular chest right there by you.[if c_1 is open and there is something in the c_1] The rectangular chest contains [a list of things in the c_1]![end if]".
The spare room part 2 is some text that varies. The spare room part 2 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The rectangular chest is empty![end if]".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. A typical one.
 ...
 You can make out a table. The table is typical.[if there is something on the s_0] On the table you can make out [a list of things on the s_0].[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_0] However, the table, like an empty table, has nothing on it.[end if]".
The washroom part 2 is some text that varies. The washroom part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The washroom part 3 is some text that varies. The washroom part 3 is " passageway leading south. There is an unblocked exit to the west.".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You are in a laundromat. A standard kind of place. You can barely contain your excitement.

 You make out [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is " drawer in the room.[if c_2 is open and there is something in the c_2] The drawer contains [a list of things in the c_2].[end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is "[if c_2 is open and the c_2 contains nothing] The drawer is empty! What a waste of a day![end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is " passageway leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The laundromat part 5 is some text that varies. The laundromat part 5 is " hatch leading south.".
...
The description of k_2 is "The metal of the rectangular passkey is antiqued.".
...
The description of o_1 is "The knife would seem to be well matched to everything else here".
...
Test quest0_0 with "unlock passageway with passkey / open passageway / go south / go south / close box"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First stop, unlock the passageway. And then, open the passageway in the washroom. And then, make an attempt to go to the south. With that done, try t".
The objective part 1 is some text that varies. The objective part 1 is "o venture south. After that, close the box. Alright, thanks!".
