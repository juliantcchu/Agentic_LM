...
Test quest0_0 with "go south / take key / unlock box with key / open box / take printer from box"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to go to the south. Next, pick up ".
The objective part 1 is some text that varies. The objective part 1 is "the key from the floor of the cubicle. With the key, make absolutely sure that the box is unlocked with the key. And then, make it so that the box is wide open. Then, take the printer from the box. On".
