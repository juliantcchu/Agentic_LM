...
The washroom part 0 is some text that varies. The washroom part 0 is "You find yourself in a washroom. A normal one.
 ...
 You can make out a table. The table is usual.[if there is something on the s_1] On the table you make out [a list of things on the s_1].[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_1] The table appears to be empty. You swear loudly.[end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a chamber. A typical one.
 ...
 You see a trunk. I mean, just wow! Isn't TextWorld just the best?[if c_0 is open and there is something in the c_0] The trunk contains [a list of things in the c_0].[end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You've just walked into a spare room. Let's see what's in here.
 ...
 You can see a workbench. The workbench is standard.[if there is something on the s_2] On the workbench you make out [a list of things on the s_2]. You shudder, but continue examining the room.[end if]".
...
The o_0 is in r_3.
The description of o_3 is "The cloak is clean.".
...
The description of o_2 is "The hat would seem to be to fit in here".
...
Test quest0_0 with "go north / go east / take sponge / go south / drop sponge"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First of all, make an effort to travel north. And then, go to the east. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "retrieve the sponge from the floor of the washroom. And then, go south. Next, place the sponge on the floor of the study. That's it!".
