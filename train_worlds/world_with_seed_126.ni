...
The chamber part 2 is some text that varies. The chamber part 2 is " What's that over there? It looks like it's a shelf. The shelf is normal.[if there is something on the s_0] On the shelf you can make out [a list of things on the s_0].[end if]".
The chamber part 3 is some text that varies. The chamber part 3 is "[if there is nothing on the s_0] The shelf appears to be empty.[end if]".
...
The kitchenette part 1 is some text that varies. The kitchenette part 1 is " box close by.[if c_1 is open and there is something in the c_1] The box contains [a list of things in the c_1].[end if]".
The kitchenette part 2 is some text that varies. The kitchenette part 2 is "[if c_1 is open and the c_1 contains nothing] The box is empty! What a waste of a day![end if]".
The kitchenette part 3 is some text that varies. The kitchenette part 3 is " Hey, want to see a platter? Look over there, a platter. The platter is usual.[if there is something on the s_1] On the platter you make out [a list of things on the s_1].[end if]".
The kitchenette part 4 is some text that varies. The kitchenette part 4 is "[if there is nothing on the s_1] The platter appears to be empty.[end if]".
The kitchenette part 5 is some text that varies. The kitchenette part 5 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The kitchenette part 6 is some text that varies. The kitchenette part 6 is " gateway leading north. There is an exit to the east. Don't worry, it is unguarded.".
...
The lounge part 0 is some text that varies. The lounge part 0 is "You are in a lounge. A standard one. You can barely contain your excitement.
 ...
 You smell an interesting smell, and follow it to a basket. You shudder, but continue examining the room.[if c_2 is open and there is something in the c_2] The basket contains [a list of things in the c_2]. You shudder, but continue examining the room.[end if]".
...
The basement part 1 is some text that varies. The basement part 1 is "[if there is nothing on the s_2]But the thing is empty.[end if]".
The basement part 2 is some text that varies. The basement part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 3 is some text that varies. The basement part 3 is " hatch leading south. There is an unguarded exit to the east.".
...
The dish-pit part 1 is some text that varies. The dish-pit part 1 is " case, which looks usual, right there by you.[if c_3 is open and there is something in the c_3] The case contains [a list of things in the c_3].[end if]".
The dish-pit part 2 is some text that varies. The dish-pit part 2 is "[if c_3 is open and the c_3 contains nothing] The case is empty! This is the worst thing that could possibly happen, ever![end if]".
The dish-pit part 3 is some text that varies. The dish-pit part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The dish-pit part 4 is some text that varies. The dish-pit part 4 is " hatch leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The dish-pit part 5 is some text that varies. The dish-pit part 5 is " gateway leading south.".
...
Test quest0_0 with "go east / unlock chest with passkey / open chest / take blanket from chest / drop blanket"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, attempt to take a trip east. After that, unlock the chest with the passkey. After that, look".
The objective part 1 is some text that varies. The objective part 1 is " and see that the chest within the chamber is wide open. Then, recover the blanket from the chest inside the chamber. And then, toss the blanket on the floor of the chamber. Once that's all handled, y".
