...
The studio part 1 is some text that varies. The studio part 1 is " gateway leading west. There is an unguarded exit to the north. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. A standard one.
 ...
 You make out a bench. [if there is something on the s_1]On the bench you can make out [a list of things on the s_1].[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is "[if there is nothing on the s_1]The bench appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is " gateway leading east. There is an exit to the south. Don't worry, it is unblocked.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. An usual kind of place. You can barely contain your excitement.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You've just walked into a cubicle.
 ...
 You smell an interesting smell, and follow it to a cabinet.[if c_0 is open and there is something in the c_0] The cabinet contains [a list of things in the c_0].[end if]".
...
The cubicle part 2 is some text that varies. The cubicle part 2 is " What's that over there? It looks like it's a mantle. [if there is something on the s_2]On the mantle you see [a list of things on the s_2].[end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is "[if there is nothing on the s_2]But the thing is empty.[end if]".
...
The description of o_1 is "The keyboard is antiquated.".
The printed name of o_1 is "keyboard".
Understand "keyboard" as o_1.
The o_1 is on the s_0.
The description of o_2 is "The mouse is cheap looking.".
...
Test quest0_0 with "go south / go south / take gummy bear from table / go north / eat gummy bear"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! First off, if it's not too much trouble, I need you to take a trip south. And then, make an effort to move south. If you can succeed at that, take t".
The objective part 1 is some text that varies. The objective part 1 is "he gummy bear from the table. After that, eat the gummy bear. And once you've done that, you win!".
