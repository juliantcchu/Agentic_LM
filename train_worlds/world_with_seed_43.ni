...
The study part 2 is some text that varies. The study part 2 is " You see a gleam over in a corner, where you can see a bureau.[if c_1 is open and there is something in the c_1] The bureau contains [a list of things in the c_1].[end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You've entered a shower. You start to take note of what's in the room.
 ...
 You see a counter. The counter is usual.[if there is something on the s_0] On the counter you can see [a list of things on the s_0].[end if]".
...
The c_1 is in r_2.
The c_1 is open.
The description of o_1 is "The novel appears to be to fit in here".
...
The description of f_1 is "that's a typical burger!".
...
Test quest0_0 with "go west / go west / go north / go east / take pencil from safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, attempt to go to the west. Next, go west. Next, try to travel north. Then, attempt to go t".
The objective part 1 is some text that varies. The objective part 1 is "o the east. Then, take the pencil from the safe. And once you've done that, you win!".
