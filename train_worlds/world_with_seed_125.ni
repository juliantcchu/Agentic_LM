...
The pantry part 1 is some text that varies. The pantry part 1 is "[if c_0 is open and the c_0 contains nothing] The box is empty! What a waste of a day![end if]".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is " normal looking chest close by.[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1].[end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_1 is open and the c_1 contains nothing] The chest is empty! What a waste of a day![end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is " You can make out a mantle. What a coincidence, weren't you just thinking about a mantle? The mantle is standard.[if there is something on the s_0] On the mantle you can make out [a list of things on the s_0].[end if]".
...
The cubicle part 6 is some text that varies. The cubicle part 6 is " passageway leading north. You don't like doors? Why not try going east, that entranceway is unblocked.".
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You find yourself in a laundry place. A typical kind of place.
 ...
 You can make out a cuboid locker. Hmmm... what else, what else?[if c_2 is open and there is something in the c_2] The cuboid locker contains [a list of things in the c_2].[end if]".
The laundry place part 1 is some text that varies. The laundry place part 1 is "[if c_2 is open and the c_2 contains nothing] The cuboid locker is empty, what a horrible day![end if]".
The laundry place part 2 is some text that varies. The laundry place part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
The laundry place part 3 is some text that varies. The laundry place part 3 is "[if there is nothing on the s_1]But the thing is empty. Hm. Oh well[end if]".
The laundry place part 4 is some text that varies. The laundry place part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundry place part 5 is some text that varies. The laundry place part 5 is " passageway leading south. There is an exit to the north. Don't worry, it is unguarded. There is an unguarded exit to the west.".
...
The c_1 is in r_0.
The c_1 is locked.
The description of c_2 is "The cuboid locker looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of o_0 is "The vacuum appears to fit in here".
...
Test quest0_0 with "go east / go south / go east / take key / unlock box with key"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go to the east. And then, try to go south. And then, make an effort to travel".
The objective part 1 is some text that varies. The objective part 1 is " east. And then, recover the key from the floor of the pantry. With the key, make absolutely sure that the box is unlocked. That's it!".
