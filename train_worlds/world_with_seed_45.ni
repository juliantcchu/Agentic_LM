...
The attic part 3 is some text that varies. The attic part 3 is " gateway leading south. You don't like doors? Why not try going north, that entranceway is unguarded. You need an unguarded exit? You should try going west.".
...
The sauna part 2 is some text that varies. The sauna part 2 is " You bend down to tie your shoe. When you stand up, you notice a table. [if there is something on the s_0]On the table you make out [a list of things on the s_0].[end if]".
The sauna part 3 is some text that varies. The sauna part 3 is "[if there is nothing on the s_0]Unfortunately, there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Well, here we are in a pantry.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is " gateway leading north. You need an unblocked exit? You should try going west.".
...
The o_2 is in r_2.
The description of o_3 is "The pen is unremarkable.".
The printed name of o_3 is "pen".
Understand "pen" as o_3.
The o_3 is in r_2.
The description of o_4 is "The insect would seem to be well matched to everything else here".
...
The description of o_1 is "The teaspoon is antiquated.".
...
Test quest0_0 with "go east / unlock gateway with latchkey / open gateway / go north / take broom from toolbox"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, head east. And then, assure that the gateway within the pantry is unlocked. After unlockin".
The objective part 1 is some text that varies. The objective part 1 is "g the gateway, ensure that the gateway in the pantry is open. If you have pulled open the gateway, go north. And then, take the broom from the toolbox inside the attic. Got that? Good!".
