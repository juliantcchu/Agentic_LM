...
The pantry part 1 is some text that varies. The pantry part 1 is " gateway leading west. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unblocked.".
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in a laundry place. A typical kind of place.
 ...
 You see a Henderson's box.[if c_0 is open and there is something in the c_0] The Henderson's box contains [a list of things in the c_0].[end if]".
The laundry place part 1 is some text that varies. The laundry place part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The Henderson's box is empty![end if]".
The laundry place part 2 is some text that varies. The laundry place part 2 is " You can make out a board. What a coincidence, weren't you just thinking about a board? [if there is something on the s_0]On the board you can make out [a list of things on the s_0].[end if]".
The laundry place part 3 is some text that varies. The laundry place part 3 is "[if there is nothing on the s_0]But the thing is empty.[end if]".
The laundry place part 4 is some text that varies. The laundry place part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The laundry place part 5 is some text that varies. The laundry place part 5 is " gateway leading east. There is an unblocked exit to the south.".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. A normal one.
 ...
 You can see a platter. [if there is something on the s_1]You see [a list of things on the s_1] on the platter. Huh, weird.[end if]".
...
The description of k_0 is "The metal of the Henderson's latchkey is antiqued.".
The printed name of k_0 is "Henderson's latchkey".
Understand "Henderson's latchkey" as k_0.
...
The description of o_1 is "The worm looks out of place here".
...
Test quest0_0 with "go north / go north / take fondue / go south / eat fondue"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to go north. Then, move north. And then, pick-up the fondue from the floor".
The objective part 1 is some text that varies. The objective part 1 is " of the scullery. After that, eat the fondue. Got that? Good!".
