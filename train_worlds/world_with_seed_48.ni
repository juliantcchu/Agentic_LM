...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room.
 ...
 You see a workbench. [if there is something on the s_0]On the workbench you can make out [a list of things on the s_0].[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk. Aw, and here you were, all excited for there to be things on it![end if]".
...
The bar part 0 is some text that varies. The bar part 0 is "You find yourself in a standard kind of place. That is to say, you're in a bar. I guess you better just go and list everything you see here.

 You see a bed. The bed is ordinary.[if there is something on the s_1] On the bed you can see [a list of things on the s_1].[end if]".
The bar part 1 is some text that varies. The bar part 1 is "[if there is nothing on the s_1] But the thing is empty.[end if]".
...
The closet part 1 is some text that varies. The closet part 1 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of trash. It would have been so cool if there was stuff on the shelf! oh well.[end if]".
The closet part 2 is some text that varies. The closet part 2 is " You make out a stand. [if there is something on the s_3]On the stand you can make out [a list of things on the s_3]. It doesn't get more TextWorld than this![end if]".
The closet part 3 is some text that varies. The closet part 3 is "[if there is nothing on the s_3]The stand appears to be empty. It would have been so cool if there was stuff on the stand.[end if]".
...
The c_0 is in r_0.
The c_0 is locked.
The description of f_1 is "that's an ordinary potato!".
...
The s_0 is in r_4.
The description of s_1 is "The bed is durable.".
...
Test quest0_0 with "go west / go west / take sandwich from workbench / go east / eat sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First off, make an effort to venture west. And then, make an effort to head west. ".
The objective part 1 is some text that varies. The objective part 1 is "And then, take the sandwich from the workbench in the spare room. And then, eat the sandwich. That's it!".
