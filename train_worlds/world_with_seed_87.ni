...
The steam room part 0 is some text that varies. The steam room part 0 is "You're now in a steam room.
 ...
 You see a dresser.[if c_0 is open and there is something in the c_0] The dresser contains [a list of things in the c_0]. The light flickers for a second, but nothing else happens.[end if]".
...
The steam room part 2 is some text that varies. The steam room part 2 is " You can make out a board. The board is standard.[if there is something on the s_0] On the board you can make out [a list of things on the s_0].[end if]".
The steam room part 3 is some text that varies. The steam room part 3 is "[if there is nothing on the s_0] But the thing hasn't got anything on it.[end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "I am honoured to announce that you are now in the chamber.
 ...
 Were you looking for a bench? Because look over there, it's a bench. Now why would someone leave that there? The bench is usual.[if there is something on the s_1] On the bench you can see [a list of things on the s_1].[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it. Hm. Oh well[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. A normal one. You can barely contain your excitement.

 Hey, want to see a stand? Look over there, a stand. [if there is something on the s_2]You see [a list of things on the s_2] on the stand.[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. Hopefully this doesn't make you too upset.[end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. A typical one. You begin to take stock of what's in the room.
...
The f_2 is in r_3.
The f_2 is edible.
The description of f_3 is "The loaf of bread looks tantalizing.".
...
Test quest0_0 with "go south / go south / go east / take cookie from dresser / eat cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First, it would be good if you could go to the south. After that, travel south. Then, make ".
The objective part 1 is some text that varies. The objective part 1 is "an attempt to venture east. Okay, and then, retrieve the cookie from the dresser inside the steam room. Then, eat the cookie. And if you do that, you're the winner!".
