...
The vault part 1 is some text that varies. The vault part 1 is " TextWorld style safe is right there by you.[if c_1 is open and there is something in the c_1] The TextWorld style safe contains [a list of things in the c_1].[end if]".
The vault part 2 is some text that varies. The vault part 2 is "[if c_1 is open and the c_1 contains nothing] The TextWorld style safe is empty! This is the worst thing that could possibly happen, ever![end if]".
The vault part 3 is some text that varies. The vault part 3 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The vault part 4 is some text that varies. The vault part 4 is " gate leading west. There is [if d_0 is open]an open[otherwise]a closed[end if]".
The vault part 5 is some text that varies. The vault part 5 is " portal leading east.".
...
The office part 1 is some text that varies. The office part 1 is " trunk in the corner.[if c_0 is open and there is something in the c_0] The trunk contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The office part 3 is some text that varies. The office part 3 is "
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The office part 4 is some text that varies. The office part 4 is " gate leading east. There is an unblocked exit to the south.".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. A standard kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'



 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is " portal leading west. You need an unguarded exit? You should try going south.".
...
The c_0 is in r_1.
The c_0 is open.
The description of c_1 is "The TextWorld style safe looks strong, and impossible to crack. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The description of o_2 is "The teaspoon would seem to be out of place here".
...
Test quest0_0 with "take key from trunk / unlock gate with key / open gate / go east / take scarf"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, pick up the key from the trunk. Then, unlock the gate in the office. And then, open the ga".
The objective part 1 is some text that varies. The objective part 1 is "te. Then, make an attempt to head east. Okay, and then, pick-up the scarf from the floor of the vault. And if you do that, you're the winner!".
