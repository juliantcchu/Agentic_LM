...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You've just shown up in a cubicle.
 ...
 You see a gleam over in a corner, where you can see a Microsoft style chest. There's something strange about this being here, but you can't put your finger on it.[if c_0 is open and there is something in the c_0] The Microsoft style chest contains [a list of things in the c_0].[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is "[if c_0 is open and the c_0 contains nothing] The Microsoft style chest is empty! This is the worst thing that could possibly happen, ever![end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is " You can make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is " toolbox right there by you.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
The cubicle part 4 is some text that varies. The cubicle part 4 is "[if c_1 is open and the c_1 contains nothing] The toolbox is empty! This is the worst thing that could possibly happen, ever![end if]".
The cubicle part 5 is some text that varies. The cubicle part 5 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The cubicle part 6 is some text that varies. The cubicle part 6 is " hatch leading north. There is an exit to the west. Don't worry, it is unblocked.".
...
The laundromat part 2 is some text that varies. The laundromat part 2 is " hatch leading south.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've entered a sauna.
 ...
 You see a shelf. The shelf is ordinary.[if there is something on the s_0] On the shelf you see [a list of things on the s_0]. Now that's what I call TextWorld![end if]".
...
The d_0 is closed.
The description of c_0 is "The Microsoft style chest looks strong, and impossible to crack. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_1 is in r_4.
The f_1 is edible.
The description of k_0 is "The Microsoft style passkey is light.".
...
The o_2 is in r_2.
The description of o_3 is "The paper towel would seem to be to fit in here".
...
The s_0 is in r_4.
The description of o_0 is "The mouse is clean.".
The printed name of o_0 is "mouse".
Understand "mouse" as o_0.
The o_0 is in the c_0.
The description of o_1 is "The shirt seems to fit in here".
...
Test quest0_0 with "open gate / go west / go south / take Microsoft style passkey / unlock Microsoft style chest with Microsoft style passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to doublecheck that the gate is open. Then, attempt to move west. Then, head sou".
The objective part 1 is some text that varies. The objective part 1 is "th. Once you get around to doing that, retrieve the Microsoft style passkey from the floor of the cubicle. If you have got the Microsoft style passkey, check that the Microsoft style chest is unlocked".
The objective part 2 is some text that varies. The objective part 2 is " with the Microsoft style passkey. And once you've done that, you win!".
