...
The garage part 0 is some text that varies. The garage part 0 is "You find yourself in a garage. An usual kind of place. Let's see what's in here.
 ...
 You smell an awful smell, and follow it to a safe.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The shower part 1 is some text that varies. The shower part 1 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
The shower part 2 is some text that varies. The shower part 2 is " You see a rack. [if there is something on the s_1]On the rack you can see [a list of things on the s_1]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The shower part 3 is some text that varies. The shower part 3 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the rack.[end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. Okay, just remember what you're here to do, and everything will go great.

 You see a counter. [if there is something on the s_2]You see [a list of things on the s_2] on the counter.[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. Oh! Why couldn't there just be stuff on it?[end if]".
...
The vault part 0 is some text that varies. The vault part 0 is "You've just sauntered into a vault.
 ...
 You scan the room for a crate, and you find a crate.[if c_2 is open and there is something in the c_2] The crate contains [a list of things in the c_2].[end if]".
The vault part 1 is some text that varies. The vault part 1 is "[if c_2 is open and the c_2 contains nothing] The crate is empty, what a horrible day![end if]".
...
The s_2 is in r_3.
The description of f_1 is "The pizza looks inviting.".
...
Test quest0_0 with "go west / go north / take sponge from table / go east / insert sponge into safe"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Here is your task for today. First of all, you could, like, make an attempt to travel west. And then, make an attempt to go to the north. With th".
The objective part 1 is some text that varies. The objective part 1 is "at done, retrieve the sponge from the table. Then, try to go to the east. Then, deposit the sponge inside the safe inside the garage. Got that? Good!".
