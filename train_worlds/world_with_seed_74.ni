...
The spare room part 0 is some text that varies. The spare room part 0 is "You've entered a spare room. Let's see what's in here.
 ...
 As if things weren't amazing enough already, you can even see a fudge scented chest.[if c_0 is open and there is something in the c_0] The fudge scented chest contains [a list of things in the c_0].[end if]".
...
The spare room part 2 is some text that varies. The spare room part 2 is " You see a trunk.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
...
The spare room part 5 is some text that varies. The spare room part 5 is " hatch leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The spare room part 6 is some text that varies. The spare room part 6 is " gate leading west.".
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Here we are in the recreation zone.
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. An ordinary one.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 1 is some text that varies. The basement part 1 is " hatch leading south. There is an exit to the north. Don't worry, it is unguarded.".
...
The cookery part 3 is some text that varies. The cookery part 3 is " You can make out a fridge. You shudder, but continue examining the room.[if c_3 is open and there is something in the c_3] The fridge contains [a list of things in the c_3].[end if]".
...
The cookery part 5 is some text that varies. The cookery part 5 is " You see a table. The table is standard.[if there is something on the s_0] On the table you can see [a list of things on the s_0]. It doesn't get more TextWorld than this![end if]".
The cookery part 6 is some text that varies. The cookery part 6 is "[if there is nothing on the s_0] However, the table, like an empty table, has nothing on it.[end if]".
...
The c_3 is in r_3.
The c_3 is open.
The description of f_1 is "The stick of butter looks heavenly.".
...
The description of f_2 is "that's a normal banana!".
...
The description of k_0 is "The metal of the fudge scented key is rusty.".
...
Test quest0_0 with "go south / open gate / go east / take fudge scented key from trunk / lock fudge scented chest with fudge scented key"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, try to take a trip south. And then, make sure that the gate is open. Afte".
The objective part 1 is some text that varies. The objective part 1 is "r that, go to the east. Then, take the fudge scented key from the trunk. Then, make sure that the fudge scented chest is locked. And once you've done that, you win!".
