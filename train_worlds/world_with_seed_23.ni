...
The cookery part 4 is some text that varies. The cookery part 4 is " hatch leading west. There is an exit to the south. Don't worry, it is unguarded.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest is in the room.[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1]![end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " hatch leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've just walked into a sauna.
 ...
 Oh, great. Here's a type I chest.[if c_2 is open and there is something in the c_2] The type I chest contains [a list of things in the c_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The description of d_1 is "it's a solid portal [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_1 is in r_2.
The c_1 is closed.
The description of c_2 is "The type I chest looks strong, and impossible to destroy. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_2 is "type I chest".
Understand "type I chest" as c_2.
Understand "type" as c_2.
Understand "I" as c_2.
Understand "chest" as c_2.
The c_2 is in r_4.
The c_2 is closed.
The description of k_1 is "The type I latchkey looks useful".
The printed name of k_1 is "type I latchkey".
Understand "type I latchkey" as k_1.
...
The o_0 is in r_4.
The description of o_2 is "The plant appears to be to fit in here".
...
The description of o_1 is "The cloak is expensive looking.".
The printed name of o_1 is "cloak".
Understand "cloak" as o_1.
The player carries the o_1.
The description of o_3 is "The vacuum is cheap looking.".
...
Test quest1_0 with "open safe / go south / take sponge / go north / insert sponge into safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. Your first objective is to open the safe within the cookery. And then, move south. ".
The objective part 1 is some text that varies. The objective part 1 is "Then, recover the sponge from the floor of the sauna. If you can get your hands on the sponge, attempt to take a trip north. And then, insert the sponge into the safe within the cookery. Once that's a".
The objective part 2 is some text that varies. The objective part 2 is "ll handled, you can stop!".
