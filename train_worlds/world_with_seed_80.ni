...
The workshop part 0 is some text that varies. The workshop part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a workshop.
 ...
 Look over there! a type 9 safe.[if c_0 is open and there is something in the c_0] The type 9 safe contains [a list of things in the c_0].[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_0 is open and the c_0 contains nothing] The type 9 safe is empty! What a waste of a day![end if]".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You've just shown up in a cubicle. You start to take note of what's in the room.
 ...
 You scan the room, seeing a safe. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1].[end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "Well, here we are in the shower.
 ...
 Look over there! a cabinet.[if c_2 is open and there is something in the c_2] The cabinet contains [a list of things in the c_2]![end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if c_2 is open and the c_2 contains nothing] The cabinet is empty! What a waste of a day![end if]".
The shower part 2 is some text that varies. The shower part 2 is " You can make out a bench. [if there is something on the s_0]You see [a list of things on the s_0] on the bench.[end if]".
The shower part 3 is some text that varies. The shower part 3 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though.[end if]".
...
The description of c_0 is "The type 9 safe looks strong, and impossible to crack. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The s_0 is in r_3.
The description of k_0 is "The type 9 key is surprisingly heavy.".
...
Test quest0_0 with "go west / go south / go east / open type 9 safe / take Comic Strip Calendar from type 9 safe"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! Here is your task for today. First step, venture west. After that, take a trip south. And then, attempt to take a trip east. That done, open the ".
The objective part 1 is some text that varies. The objective part 1 is "type 9 safe within the workshop. Having opened the type 9 safe, pick up the Comic Strip Calendar from the type 9 safe. Once that's all handled, you can stop!".
