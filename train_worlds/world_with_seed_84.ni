...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. An ordinary one. I guess you better just go and list everything you see here.

 If you haven't noticed it already, there seems to be something there by the wall, it's a counter. [if there is something on the s_0]On the counter you make out [a list of things on the s_0].[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though. You think about smashing the counter to bits, throwing the bits into a pit, etc, until you get bored.[end if]".
The kitchenette part 2 is some text that varies. The kitchenette part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The kitchenette part 3 is some text that varies. The kitchenette part 3 is " gate leading west. There is an unblocked exit to the east. There is an exit to the south. Don't worry, it is unblocked.".
...
The chamber part 2 is some text that varies. The chamber part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The chamber part 3 is some text that varies. The chamber part 3 is " gate leading east. There is an unguarded exit to the south.".
...
The closet part 0 is some text that varies. The closet part 0 is "You have moved into the most ordinary of all possible closets. You can barely contain your excitement.

 You scan the room, seeing a rack. [if there is something on the s_1]You see [a list of things on the s_1] on the rack.[end if]".
The closet part 1 is some text that varies. The closet part 1 is "[if there is nothing on the s_1]The rack appears to be empty.[end if]".
...
The o_0 is in r_4.
The description of o_1 is "The pillow appears well matched to everything else here".
The printed name of o_1 is "pillow".
Understand "pillow" as o_1.
The o_1 is in r_2.
The description of o_2 is "The fly larva appears out of place here".
...
Test quest0_0 with "go north / go east / take nest of shrimp / go west / put nest of shrimp on counter"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First of all, you could, like, venture north. If you can finish that, go e".
The objective part 1 is some text that varies. The objective part 1 is "ast. And then, retrieve the nest of shrimp from the floor of the bedroom. After that, take a trip west. Once you manage that, sit the nest of shrimp on the counter. Once that's all handled, you can st".
The objective part 2 is some text that varies. The objective part 2 is "op!".
