...
The launderette part 0 is some text that varies. The launderette part 0 is "You've just sauntered into a launderette.
 ...
 Look out! It's a- oh, never mind, it's just a chest.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if c_0 is open and the c_0 contains nothing] The chest is empty, what a horrible day![end if]".
The launderette part 2 is some text that varies. The launderette part 2 is " You can see a dresser. Now why would someone leave that there?[if c_1 is open and there is something in the c_1] The dresser contains [a list of things in the c_1]. Now why would someone leave that there?[end if]".
The launderette part 3 is some text that varies. The launderette part 3 is "[if c_1 is open and the c_1 contains nothing] The dresser is empty! What a waste of a day![end if]".
The launderette part 4 is some text that varies. The launderette part 4 is " You can make out a formless box.[if c_2 is open and there is something in the c_2] The formless box contains [a list of things in the c_2].[end if]".
The launderette part 5 is some text that varies. The launderette part 5 is "[if c_2 is open and the c_2 contains nothing] The formless box is empty! What a waste of a day![end if]".
The launderette part 6 is some text that varies. The launderette part 6 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The launderette part 7 is some text that varies. The launderette part 7 is " door leading east. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The office part 1 is some text that varies. The office part 1 is " passageway leading south. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The office part 2 is some text that varies. The office part 2 is " door leading west.".
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just walked into a chamber.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is " passageway leading north. You need an unguarded exit? You should try going west.".
...
The c_1 is in r_1.
The c_1 is open.
The description of c_2 is "The formless box looks strong, and impossible to crack. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_2 is in r_1.
The c_2 is closed.
The description of f_1 is "The cashew looks heavenly.".
...
The description of o_2 is "The vacuum appears to be out of place here".
...
Test quest0_0 with "go west / take keycard from dresser / unlock chest with keycard / open chest / take mop from chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First thing I need you to do is to attempt to travel west. With that accomplished, take the keycard from the dresser. And then, insert the keycard into the c".
The objective part 1 is some text that varies. The objective part 1 is "hest's lock to unlock it. Then, open the chest inside the launderette. After pulling open the chest, recover the mop from the chest. That's it!".
