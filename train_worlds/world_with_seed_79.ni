...
The garage part 0 is some text that varies. The garage part 0 is "This might come as a shock to you, but you've just fallen into a garage. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You see a chest.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
The garage part 1 is some text that varies. The garage part 1 is "[if c_0 is open and the c_0 contains nothing] The chest is empty! What a waste of a day![end if]".
The garage part 2 is some text that varies. The garage part 2 is " Oh, great. Here's a workbench. [if there is something on the s_1]On the workbench you see [a list of things on the s_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The garage part 5 is some text that varies. The garage part 5 is " door leading west. There is an exit to the east. Don't worry, it is unguarded.".
...
The studio part 0 is some text that varies. The studio part 0 is "Well, here we are in the studio. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 Look out! It's a- oh, never mind, it's just a table. The table is normal.[if there is something on the s_2] On the table you can make out [a list of things on the s_2].[end if]".
...
The studio part 4 is some text that varies. The studio part 4 is " door leading east.".
...
The shower part 2 is some text that varies. The shower part 2 is " You see a bench. The bench is ordinary.[if there is something on the s_0] On the bench you make out [a list of things on the s_0].[end if]".
The shower part 3 is some text that varies. The shower part 3 is "[if there is nothing on the s_0] However, the bench, like an empty bench, has nothing on it.[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. An usual one.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a locker.[if c_2 is open and there is something in the c_2] The locker contains [a list of things in the c_2].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?



 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is " gate leading south. You need an unguarded exit? You should try going east.".
...
The c_2 is in r_4.
The c_2 is closed.
The description of o_0 is "The Comic Strip Calendar would seem to be out of place here".
...
Test quest1_0 with "close door / go east / take latchkey from bench / go west / lock door with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First step, doublecheck that the door is shut. After that, venture east. Then, pick up the latchkey from the bench. Af".
The objective part 1 is some text that varies. The objective part 1 is "ter stealing the latchkey, try to venture west. Okay, and then, assure that the door is locked with the latchkey. Got that? Good!".
