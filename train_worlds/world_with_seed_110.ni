...
The scullery part 1 is some text that varies. The scullery part 1 is "[if c_0 is open and the c_0 contains nothing] The locker is empty, what a horrible day![end if]".
The scullery part 2 is some text that varies. The scullery part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is " gate leading west. There is an unguarded exit to the east. You need an unblocked exit? You should try going north.".
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A standard one.
 ...
 Were you looking for a safe? Because look over there, it's a safe. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The closet part 1 is some text that varies. The closet part 1 is "[if c_1 is open and the c_1 contains nothing] The safe is empty! This is the worst thing that could possibly happen, ever![end if]".
The closet part 2 is some text that varies. The closet part 2 is " You make out a chest. You look around you, at all the containers and supporters, doors and objects, and you think to yourself. Why? Why Textworld?[if c_2 is open and there is something in the c_2] The chest contains [a list of things in the c_2].[end if]".
The closet part 3 is some text that varies. The closet part 3 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The chest is empty![end if]".
The closet part 4 is some text that varies. The closet part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The closet part 5 is some text that varies. The closet part 5 is " gate leading east. You need an unguarded exit? You should try going south.".
...
The vault part 1 is some text that varies. The vault part 1 is " suitcase.[if c_3 is open and there is something in the c_3] The suitcase contains [a list of things in the c_3].[end if]".
The vault part 2 is some text that varies. The vault part 2 is "[if c_3 is open and the c_3 contains nothing] The suitcase is empty! This is the worst thing that could possibly happen, ever![end if]".
...
Test quest0_0 with "go north / open gate / go east / open locker / take knife from locker"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to make an effort to travel north. And then, ensure that the gate inside".
The objective part 1 is some text that varies. The objective part 1 is " the closet is open. And then, take a trip east. Then, open the locker inside the scullery. And then, pick up the knife from the locker. And once you've done that, you win!".
