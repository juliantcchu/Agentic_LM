...
The restroom part 0 is some text that varies. The restroom part 0 is "You have come into a restroom. Not the restroom you'd expect. No, this is a restroom. You begin to take stock of what's here.

 You make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The restroom part 1 is some text that varies. The restroom part 1 is " fudge scented safe in the corner.[if c_0 is open and there is something in the c_0] The fudge scented safe contains [a list of things in the c_0].[end if]".
The restroom part 2 is some text that varies. The restroom part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The fudge scented safe is empty![end if]".
The restroom part 3 is some text that varies. The restroom part 3 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The restroom part 4 is some text that varies. The restroom part 4 is " gateway leading west. You need an unguarded exit? You should try going north.".
...
The attic part 0 is some text that varies. The attic part 0 is "You find yourself in an attic. A typical one.
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The attic part 1 is some text that varies. The attic part 1 is " gateway leading east. There is [if d_0 is open]an open[otherwise]a closed[end if]".
The attic part 2 is some text that varies. The attic part 2 is " hatch leading north.".
...
The steam room part 0 is some text that varies. The steam room part 0 is "You've just walked into a steam room.
 ...
 You make out a table. The table is usual.[if there is something on the s_0] On the table you make out [a list of things on the s_0]. Hmmm... what else, what else?[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a bedchamber. An ordinary kind of place. You begin to take stock of what's here.
 ...
 You see a chest.[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1]. Is this it? Is this what you came to TextWorld to see? a chest?[end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is "[if c_1 is open and the c_1 contains nothing] The chest is empty! What a waste of a day![end if]".
...
The d_0 is locked.
The description of c_0 is "The fudge scented safe looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_1 is in r_4.
The c_1 is closed.
The description of f_1 is "The onion looks delicious.".
The printed name of f_1 is "onion".
Understand "onion" as f_1.
The f_1 is in r_3.
The f_1 is edible.
The description of o_0 is "The pair of pants would seem to be out of place here".
...
The o_1 is in r_1.
The description of o_2 is "The iron appears to be well matched to everything else here".
...
Test quest0_0 with "go north / open chest / take fudge scented keycard from chest / go south / unlock fudge scented safe with fudge scented keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First off, go north. Okay, and then, open the chest. After that, pick up the fudge scented keycard from the chest. After getting the fudge scented ".
The objective part 1 is some text that varies. The objective part 1 is "keycard, venture south. And then, unlock the fudge scented safe within the restroom. And if you do that, you're the winner!".
