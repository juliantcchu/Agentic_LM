...
The spare room part 2 is some text that varies. The spare room part 2 is " You make out a counter. The counter is typical.[if there is something on the s_0] On the counter you make out [a list of things on the s_0]. Now that's what I call TextWorld![end if]".
The spare room part 3 is some text that varies. The spare room part 3 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. You think about smashing the counter to bits, throwing the bits into the garbage, etc, until you get bored.[end if]".
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. A normal one.
 ...
 You scan the room for a safe, and you find a safe.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
The basement part 1 is some text that varies. The basement part 1 is "[if c_1 is open and the c_1 contains nothing] The safe is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The o_1 is in r_2.
The description of o_2 is "The laptop is expensive looking.".
The printed name of o_2 is "laptop".
Understand "laptop" as o_2.
The o_2 is in r_1.
The description of o_3 is "The printer seems to fit in here".
The printed name of o_3 is "printer".
Understand "printer" as o_3.
The o_3 is in r_4.
...
The description of o_0 is "The cloak would seem to be well matched to everything else here".
...
Test quest0_0 with "go south / go south / go east / go north / take cloak from counter"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, venture south. And then, attempt to head south. That done, make an attempt to go to the east".
The objective part 1 is some text that varies. The objective part 1 is ". Once you get through with that, travel north. Then, retrieve the cloak from the counter in the spare room. And once you've done that, you win!".
