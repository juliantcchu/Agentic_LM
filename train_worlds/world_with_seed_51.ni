...
The playroom part 1 is some text that varies. The playroom part 1 is " non-euclidean safe.[if c_0 is open and there is something in the c_0] The non-euclidean safe contains [a list of things in the c_0].[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " gate leading north. There is an exit to the east. Don't worry, it is unguarded. There is an unblocked exit to the south.".
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A normal kind of place. You begin looking for stuff.

 You smell an interesting smell, and follow it to a rack. The rack is normal.[if there is something on the s_0] On the rack you make out [a list of things on the s_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The cookery part 1 is some text that varies. The cookery part 1 is "[if there is nothing on the s_0] However, the rack, like an empty rack, has nothing on it.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just shown up in a pantry. The room is well lit.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is " gate leading south. There is an exit to the east. Don't worry, it is unblocked.".
...
The f_3 is in r_0.
The f_3 is edible.
The description of k_1 is "The non-euclidean key is heavier than it looks.".
...
The description of f_1 is "The durian looks heavenly.".
...
Test quest0_0 with "unlock gate with passkey / open gate / go south / go east / close non-euclidean safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to unlock the gate. After that, ensure that the gate".
The objective part 1 is some text that varies. The objective part 1 is " within the pantry is open. And then, make an attempt to move south. Okay, and then, head east. Then, make absolutely sure that the non-euclidean safe in the playroom is closed. Once that's all handle".
