...
The cookhouse part 1 is some text that varies. The cookhouse part 1 is " locker close by.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The locker is empty![end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The cookhouse part 4 is some text that varies. The cookhouse part 4 is " gateway leading north. There is an exit to the west. Don't worry, it is unblocked.".
...
The study part 2 is some text that varies. The study part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 3 is some text that varies. The study part 3 is " gateway leading south. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the west. Don't worry, it is unblocked.".
...
The bedchamber part 1 is some text that varies. The bedchamber part 1 is " safe.[if c_2 is open and there is something in the c_2] The safe contains [a list of things in the c_2].[end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The safe is empty![end if]".
...
The lounge part 0 is some text that varies. The lounge part 0 is "You are in a lounge. An ordinary kind of place. You start to take note of what's in the room.

 You see a bar. The bar is ordinary.[if there is something on the s_0] On the bar you make out [a list of things on the s_0].[end if]".
The lounge part 1 is some text that varies. The lounge part 1 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it.[end if]".
...
The f_0 is in r_1.
The f_0 is edible.
The description of o_0 is "The pair of pants is cheap looking.".
...
Test quest0_0 with "go east / go north / take keycard from coffer / go south / unlock locker with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting game of TextWorld! Here is how to play! Your first objective is to try to travel east. And then, make an effort to move north. And then, pick up the keycard from the coffer".
The objective part 1 is some text that varies. The objective part 1 is " in the study. And then, attempt to take a trip south. After that, unlock the locker with the keycard. Once that's all handled, you can stop!".
