...
The garage part 0 is some text that varies. The garage part 0 is "You've just walked into a garage.
 ...
 You make out a TextWorld box. Make a note of this, you might have to put stuff on or in it later on.[if c_0 is open and there is something in the c_0] The TextWorld box contains [a list of things in the c_0].[end if]".
...
The garage part 2 is some text that varies. The garage part 2 is " You make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The garage part 3 is some text that varies. The garage part 3 is " crate.[if c_1 is open and there is something in the c_1] The crate contains [a list of things in the c_1].[end if]".
The garage part 4 is some text that varies. The garage part 4 is "[if c_1 is open and the c_1 contains nothing] The crate is empty! This is the worst thing that could possibly happen, ever![end if]".
The garage part 5 is some text that varies. The garage part 5 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The garage part 6 is some text that varies. The garage part 6 is " gateway leading west. You need an unblocked exit? You should try going south.".
...
The study part 0 is some text that varies. The study part 0 is "You've just sauntered into a study.
 ...
 You see an armchair. The armchair is typical.[if there is something on the s_0] On the armchair you make out [a list of things on the s_0].[end if]".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in a cellar. An ordinary kind of place.
 ...
 You can make out a workbench. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_1]You see [a list of things on the s_1] on the workbench.[end if]".
The cellar part 1 is some text that varies. The cellar part 1 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. What's the point of an empty workbench?[end if]".
...
The pantry part 1 is some text that varies. The pantry part 1 is " portal leading north. There is an exit to the south. Don't worry, it is unblocked.".
...
The description of o_3 is "The bug looks out of place here".
The printed name of o_3 is "bug".
Understand "bug" as o_3.
The player carries the o_3.
The description of o_4 is "The disk seems out of place here".
...
Test quest0_0 with "open gateway / go east / open crate / take TextWorld latchkey from crate / unlock TextWorld box with TextWorld latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First of all, open the gateway within the study. And then, make an effort to travel east. Then, open th".
The objective part 1 is some text that varies. The objective part 1 is "e crate. Then, take the TextWorld latchkey from the crate. After getting the TextWorld latchkey, make sure that the TextWorld box is unlocked. And once you've done that, you win!".
