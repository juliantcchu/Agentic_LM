...
The basement part 2 is some text that varies. The basement part 2 is " You see a workbench. [if there is something on the s_0]You see [a list of things on the s_0] on the workbench.[end if]".
The basement part 3 is some text that varies. The basement part 3 is "[if there is nothing on the s_0]But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The basement part 4 is some text that varies. The basement part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 5 is some text that varies. The basement part 5 is " hatch leading south. There is an exit to the east. Don't worry, it is unguarded. There is an unblocked exit to the west.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. A typical one. The room is well lit.
...
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_1 is open and the c_1 contains nothing] The bureau is empty! This is the worst thing that could possibly happen, ever![end if]".
The workshop part 2 is some text that varies. The workshop part 2 is " You see a shelf. [if there is something on the s_1]On the shelf you see [a list of things on the s_1]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The workshop part 3 is some text that varies. The workshop part 3 is "[if there is nothing on the s_1]But the thing is empty, unfortunately.[end if]".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've entered a canteen.
 ...
 Look out! It's a- oh, never mind, it's just a chest.[if c_2 is open and there is something in the c_2] The chest contains [a list of things in the c_2].[end if]".
...
The canteen part 2 is some text that varies. The canteen part 2 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The canteen part 3 is some text that varies. The canteen part 3 is " hatch leading north. You need an unblocked exit? You should try going west.".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "This might come as a shock to you, but you've just moved into a cookhouse. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You can see [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is " case.[if c_3 is open and there is something in the c_3] The case contains [a list of things in the c_3].[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is "[if c_3 is open and the c_3 contains nothing] The case is empty! What a waste of a day![end if]".
...
The salon part 0 is some text that varies. The salon part 0 is "You've entered a salon.
 ...
 You can make out a bed stand. Wow, isn't TextWorld just the best? [if there is something on the s_2]You see [a list of things on the s_2] on the bed stand.[end if]".
The salon part 1 is some text that varies. The salon part 1 is "[if there is nothing on the s_2]But the thing is empty, unfortunately.[end if]".
...
Test quest0_0 with "go west / go west / take latchkey from bureau / go east / lock box with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to go west. And then, move west. If you can accompli".
The objective part 1 is some text that varies. The objective part 1 is "sh that, retrieve the latchkey from the bureau. Then, attempt to go east. If you can manage that, Put the latchkey into the box inside the basement to lock it. And if you do that, you're the winner!".
