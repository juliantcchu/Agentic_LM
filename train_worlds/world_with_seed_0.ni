...
The cellar part 2 is some text that varies. The cellar part 2 is "[if c_0 is open and the c_0 contains nothing] The locker is empty! What a waste of a day![end if]".
The cellar part 3 is some text that varies. The cellar part 3 is " What's that over there? It looks like it's a safe.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1]. You can't wait to tell the folks at home about this![end if]".
The cellar part 4 is some text that varies. The cellar part 4 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The safe is empty![end if]".
The cellar part 5 is some text that varies. The cellar part 5 is " You can make out a box.[if c_2 is open and there is something in the c_2] The box contains [a list of things in the c_2].[end if]".
The cellar part 6 is some text that varies. The cellar part 6 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The cellar part 7 is some text that varies. The cellar part 7 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The cellar part 8 is some text that varies. The cellar part 8 is " portal leading west. There is an unguarded exit to the south.".
...
The shower part 2 is some text that varies. The shower part 2 is " door leading south.".
...
The chamber part 1 is some text that varies. The chamber part 1 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The dresser is empty![end if]".
...
The laundromat part 1 is some text that varies. The laundromat part 1 is " door leading north. There is an exit to the south. Don't worry, it is unguarded.".
...
Test quest0_0 with "take key / unlock safe with key / open safe / take latchkey from safe / lock locker with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, retrieve the key from the floor of the cellar. Once you have taken the key, unlock the safe. Then, open the safe. And then, recover the latchkey fr".
The objective part 1 is some text that varies. The objective part 1 is "om the safe. After that, assure that the locker is locked with the latchkey. Once that's all handled, you can stop!".
