...
The scullery part 0 is some text that varies. The scullery part 0 is "Ah, the scullery. This is some kind of scullery, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it. You begin looking for stuff.



 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is " door leading east. There is an unguarded exit to the west.".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You're now in the kitchenette. Okay, just remember what you're here to do, and everything will go great.
 ...
 You make out a chest. Huh, weird.[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You're now in a spare room.
 ...
 You make out a suitcase. There's something strange about this thing being here, but you don't have time to worry about that now.[if c_0 is open and there is something in the c_0] The suitcase contains [a list of things in the c_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is "[if c_0 is open and the c_0 contains nothing] The suitcase is empty! This is the worst thing that could possibly happen, ever![end if]".
The spare room part 2 is some text that varies. The spare room part 2 is " You can make out a box.[if c_2 is open and there is something in the c_2] The box contains [a list of things in the c_2].[end if]".
The spare room part 3 is some text that varies. The spare room part 3 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The spare room part 4 is some text that varies. The spare room part 4 is " You make out a table. The table is standard.[if there is something on the s_0] On the table you make out [a list of things on the s_0].[end if]".
...
The spare room part 7 is some text that varies. The spare room part 7 is " gate leading north. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The spare room part 8 is some text that varies. The spare room part 8 is " door leading west.".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You're now in the restroom. You can barely contain your excitement.



 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The restroom part 1 is some text that varies. The restroom part 1 is " gate leading south. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The c_2 is in r_1.
The c_2 is locked.
The description of o_2 is "The mat is clean.".
...
The description of o_1 is "The sponge is dirty.".
...
Test quest0_0 with "open door / go east / take worm from suitcase / go west / drop worm"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, look and see that the door within the scullery is wide open.".
The objective part 1 is some text that varies. The objective part 1 is " Then, head east. Then, recover the worm from the suitcase. Then, attempt to move west. Okay, and then, throw the worm on the floor of the scullery. Alright, thanks!".
