...
The bedchamber part 1 is some text that varies. The bedchamber part 1 is "[if c_0 is open and the c_0 contains nothing] The box is empty! What a waste of a day![end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is " You make out a locker.[if c_1 is open and there is something in the c_1] The locker contains [a list of things in the c_1].[end if]".
The bedchamber part 3 is some text that varies. The bedchamber part 3 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The locker is empty![end if]".
The bedchamber part 4 is some text that varies. The bedchamber part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedchamber part 5 is some text that varies. The bedchamber part 5 is " passageway leading east. You need an unguarded exit? You should try going south. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've entered a canteen.
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is " passageway leading west. You need an unguarded exit? You should try going south.".
...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. An usual one.
 ...
 You see a fridge. Something scurries by right in the corner of your eye. Probably nothing.[if c_2 is open and there is something in the c_2] The fridge contains [a list of things in the c_2]. Now that's what I call TextWorld![end if]".
The cookery part 1 is some text that varies. The cookery part 1 is "[if c_2 is open and the c_2 contains nothing] The fridge is empty! What a waste of a day![end if]".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You're now in a restroom. You begin looking for stuff.
...
The f_0 is in r_3.
The f_0 is edible.
The description of f_1 is "that's an ordinary blackberry!".
...
The description of o_1 is "The butterfly seems out of place here".
The printed name of o_1 is "butterfly".
Understand "butterfly" as o_1.
The o_1 is in r_3.
The description of o_2 is "The soap dispenser appears out of place here".
...
Test quest0_0 with "go east / go south / take key / go north / unlock box with key"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, go east. After that, attempt to travel south. After that, pick up the key from the floor of the cookery. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, make an attempt to go north. Then, check that the box within the bedchamber is unlocked with the key. Once that's all handled, you can stop!".
