...
The cookhouse part 3 is some text that varies. The cookhouse part 3 is " gateway leading north. There is an exit to the west. Don't worry, it is unblocked.".
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. A normal one. The room is well lit.
 ...
 You see a chair. The chair is ordinary.[if there is something on the s_0] On the chair you can see [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The study part 2 is some text that varies. The study part 2 is "
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The study part 3 is some text that varies. The study part 3 is " gateway leading south. There is [if d_0 is open]an open[otherwise]a closed[end if]".
The study part 4 is some text that varies. The study part 4 is " door leading west.".
...
The washroom part 1 is some text that varies. The washroom part 1 is " drawer.[if c_1 is open and there is something in the c_1] The drawer contains [a list of things in the c_1].[end if]".
The washroom part 2 is some text that varies. The washroom part 2 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The drawer is empty![end if]".
The washroom part 3 is some text that varies. The washroom part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The washroom part 4 is some text that varies. The washroom part 4 is " door leading east. There is an exit to the north. Don't worry, it is unblocked.".
...
The shower part 0 is some text that varies. The shower part 0 is "Well how about that, you are in a place we're calling a shower. I guess you better just go and list everything you see here.
...
The description of o_2 is "The shirt appears well matched to everything else here".
...
The description of o_1 is "The cd appears to be to fit in here".
...
Test quest1_0 with "close box / go west / take latchkey / go east / lock box with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to close the box in the cookhouse. And then, go west. That done, lift the latchkey from the floor of the sauna. After that, go to the".
The objective part 1 is some text that varies. The objective part 1 is " east. Then, Deposit the latchkey into the box inside the cookhouse to lock it. And once you've done that, you win!".
